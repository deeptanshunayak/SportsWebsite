      ...
      <div className='back1'>
                <div class="container">
                    <div className='row pt-3 pb-3'>
                      <div className='col-12 col-sm-4'><p className='text-light'><img src={v1}></img>&nbsp;The Strand 14 Sector,Faridabad,Haryana</p></div>
                      <div className='col-12 col-sm-4'><p className='text-light'><img src={v2}></img>&nbsp;Send an email,helpus24@gmail.com</p></div>
                      <div className='col-12 col-sm-4'><p className='text-light'><img src={v3}></img>&nbsp;Helpline and Support-8857002451</p></div>
